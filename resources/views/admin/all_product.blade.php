                    ...
                    <tr>
                        ...
                        <td><span class="text-ellipsis">
                                ...
                                if ($all_products->product_status == 0) { ?>
                                    <a href="{{URL::to('/unactive-product/' . $all_products->product_id)}}"><span style="font-size: 35px;" class="fa-thumb-styling fa fa-thumbs-down"></span></a>
                                <?php } else {
                                ?>
                                    <a href="{{URL::to('/active-product/' . $all_products->product_id)}}"><span style="font-size: 35px;" class="fa-thumb-styling fa fa-thumbs-up"></span></a>
                                <?php }
                                ?>
                            </span>
                        </td>
